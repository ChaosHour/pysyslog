...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        python3 parsit.py -f /path/to/your/file -d 2022-01-01 -s error
        python3 parsit.py -f /path/to/your/file -s error
        python3 parsit.py -f /path/to/your/file -d $(date -d "2 days ago" +%Y-%m-%d) -s error
        python3 parsit.py -f /path/to/your/file -d 2022-01-01 -s error -l 10
        ''',
